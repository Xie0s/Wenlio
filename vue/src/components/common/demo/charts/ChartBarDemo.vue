<!--
  ChartBarDemo.vue - 交互式柱状图演示组件
  职责：使用 Unovis VisGroupedBar 展示交互式柱状图，含 desktop/mobile 切换、日期轴、Crosshair Tooltip
  ...
  <Card class="py-4 sm:py-0">
    <CardHeader class="flex flex-col items-stretch border-b !p-0 sm:flex-row">
      <div class="flex flex-1 flex-col justify-center gap-1 px-6 py-5 sm:py-6">
        <CardTitle>柱状图 - 交互式</CardTitle>
        <CardDescription>近 3 个月访问量统计</CardDescription>
      </div>
      <div class="flex">
        <button
