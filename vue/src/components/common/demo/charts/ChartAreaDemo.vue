<!--
  ChartAreaDemo.vue - 交互式面积图演示组件
  职责：使用 Unovis VisArea + VisLine 展示带渐变填充的面积图，含时间范围筛选、Crosshair Tooltip、图例
  ...
  <Card class="pt-0">
    <CardHeader class="flex items-center gap-2 space-y-0 border-b py-5 sm:flex-row">
      <div class="grid flex-1 gap-1">
        ...
        <CardDescription>近 3 个月访问量趋势</CardDescription>
      </div>
      <Select v-model="timeRange">
        ...
        <SelectContent class="rounded-xl">
          <SelectItem value="90d" class="rounded-lg">近 3 个月</SelectItem>
          <SelectItem value="30d" class="rounded-lg">近 30 天</SelectItem>
          <SelectItem value="7d" class="rounded-lg">近 7 天</SelectItem>
        </SelectContent>
      </Select>
    </CardHeader>
