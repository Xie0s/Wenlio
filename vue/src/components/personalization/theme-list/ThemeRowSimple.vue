<!--
  src/components/personalization/theme-list/ThemeRowSimple.vue
  职责：主题列表简洁行子组件，渲染标准单行主题信息
...
<template>
  <div
    class="group flex items-center gap-2.5 px-4 py-3.5 cursor-pointer transition-colors hover:bg-muted/50 active:bg-muted/60 sm:px-5"
  ...
  >
    ...
    <div class="flex items-center gap-2.5 shrink-0">
      ...
      <ChevronRight v-else class="h-4 w-4 text-muted-foreground/30 group-hover:text-muted-foreground/70 transition-colors" />
    </div>
  </div>
</template>
