<!--
  src/components/personalization/theme-list/ThemeRowTwoCol.vue
  职责：主题列表双列卡片子组件，渲染独立边框主题条目
...
<template>
  <div
    class="group flex items-center gap-2.5 rounded-3xl border border-border/60 bg-card px-4 py-3.5 cursor-pointer transition-colors hover:bg-muted/30 active:bg-muted/60"
  ...
  >
    ...
    <div class="flex items-center gap-2.5 shrink-0">
      ...
      <ChevronRight v-else class="h-4 w-4 text-muted-foreground/30" />
    </div>
  </div>
</template>
